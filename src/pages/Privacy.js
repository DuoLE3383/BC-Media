  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <section>
        <h2>Introduction</h2>
        <p>
          Welcome to Thao Ha BC Media. We are committed to protecting your personal information and your right to privacy. 
      ...
      <section>
        ...
        <p>
          We collect personal information that you voluntarily provide to us when you register, express an interest in obtaining information 
        ...
        <ul>
          ...
          <li><strong>Usage Data:</strong> IP address, browser type, and information on how you use our site.</li>
        </ul>
      </section>
      ...
      <section>
        <h2>Data Security</h2>
        <p>
          We implement reasonable security measures to protect the information we collect. However, please remember that no method of 
